...
function testandoEscopo() {
    let y = 20;
    let p = 10;
    console.log(`Y e P dentro da função é: ${y} e ${p}`);
}
...
console.log(`Y e P fora da função é: ${y} e ${p}`);
...
console.log(customGreeting("Martins", "Tudo bem ?"));
...
const faltas = (nome, faltas = 5) => {
    for(let f = 0; f < faltas; f++) {
        console.log(`${nome}, Você faltou ${faltas} vezes`)
    }
}
